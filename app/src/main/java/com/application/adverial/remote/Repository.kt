...
class Repository(val context: Context) {
    ...
    fun mainCategory() {
        ...
        call.enqueue(
                object : retrofit2.Callback<MainCategory> {
                    override fun onResponse(
                            call: Call<MainCategory>,
                            response: Response<MainCategory>
                    ) {
    ...
    fun categoryAds(id: String, type: String, page: Int) {
        ...
        call.enqueue(
                object : retrofit2.Callback<CategoryAds> {
                    override fun onResponse(
                            call: Call<CategoryAds>,
                            response: Response<CategoryAds>
                    ) {
                        categoryAds.value = response.body()
                    }
    ...
    fun signup(
        ...
        call.enqueue(
                object : retrofit2.Callback<Signup> {
    ...
    fun verifyCode(email: String, code: String) {
        ...
        call.enqueue(
                object : retrofit2.Callback<VerifyCode> {
                    override fun onResponse(
                            call: Call<VerifyCode>,
                            response: Response<VerifyCode>
                    ) {
                        verifyCode.value = response.body()
                    }
    ...
    fun sendCode(email: String) {
        ...
        call.enqueue(
                object : retrofit2.Callback<com.application.adverial.remote.model.Response> {
                    override fun onResponse(
                            call: Call<com.application.adverial.remote.model.Response>,
                            response: Response<com.application.adverial.remote.model.Response>
                    ) {
                        sendCode.value = response.body()
                    }
    ...
    fun adDetails(id: String) {
        ...
        call.enqueue(
                object : retrofit2.Callback<AdDetails> {
                    override fun onResponse(call: Call<AdDetails>, response: Response<AdDetails>) {
                        adDetails.value = response.body()
                    }
    ...
    fun showRoom(type: String, page: Int) {
        ...
        call.enqueue(
                object : retrofit2.Callback<ShowRoom> {
    ...
    fun search(keyword: String, type: String) {
        ...
        call.enqueue(
                object : retrofit2.Callback<Search> {
        ...
        call.enqueue(
                object : retrofit2.Callback<com.application.adverial.remote.model.Response> {
                    override fun onResponse(
                        ...
                        clearSearch.value = response.body()
                    }
                    override fun onFailure(
                            call: Call<com.application.adverial.remote.model.Response>,
                            t: Throwable
    ...
    fun latestSearch() {
        ...
        call.enqueue(
                object : retrofit2.Callback<LatestSearch> {
                    override fun onResponse(
                            call: Call<LatestSearch>,
                            response: Response<LatestSearch>
                    ) {
                        latestSearch.value = response.body()
                    }
        ...
        call.enqueue(
                object : retrofit2.Callback<com.application.adverial.remote.model.Response> {
                    override fun onResponse(
                        ...
                        removeFavorite.value = response.body()
                    }
                    override fun onFailure(
                            call: Call<com.application.adverial.remote.model.Response>,
                            t: Throwable
        ...
        call.enqueue(
                object : retrofit2.Callback<com.application.adverial.remote.model.Response> {
                    override fun onResponse(
                        ...
                        addFavorite.value = response.body()
                    }
                    override fun onFailure(
                            call: Call<com.application.adverial.remote.model.Response>,
                            t: Throwable
    ...
    fun deactiveAds() {
        ...
        call.enqueue(
                object : retrofit2.Callback<Search> {
                    override fun onResponse(call: Call<Search>, response: Response<Search>) {
                        deactiveAds.value = response.body()
                    }
                    override fun onFailure(call: Call<Search>, t: Throwable) {}
                }
        )
    ...
    fun categoryOptions(id: String) {
        ...
        call.enqueue(
                object : retrofit2.Callback<CategoryOptions> {
                    override fun onResponse(
                            call: Call<CategoryOptions>,
                            response: Response<CategoryOptions>
                    ) {
    ...
    fun addAdInfo(title: String, price: String, desc: String, idArray: String, currency: String) {
        ...
        if (data.all.isNotEmpty()) {
            ...
            call.enqueue(
                    object : retrofit2.Callback<AddAdInfo> {
                        override fun onResponse(
                                call: Call<AddAdInfo>,
                                response: Response<AddAdInfo>
                        ) {
                            addAdInfo.value = response.body()
                        }
    ...
    fun country() {
        ...
        call.enqueue(
                object : retrofit2.Callback<City> {
        ...
        call.enqueue(
                object : retrofit2.Callback<com.application.adverial.remote.model.Response> {
                    override fun onResponse(
                        ...
                        addAdLocation.value = response.body()
                    }
                    override fun onFailure(
                            call: Call<com.application.adverial.remote.model.Response>,
                            t: Throwable
    ...
    fun image(picture: String, adId: String) {
        ...
        call.enqueue(
                object : retrofit2.Callback<ImageUpload> {
                    override fun onResponse(
    ...
    //            override fun onResponse(call: Call<PublishAd>, response: Response<PublishAd>) {
    // publishAd.value = response.body() }
    ...
    fun publishAd(
        ...
        call.enqueue(
                object : retrofit2.Callback<PublishAd> {
                    override fun onResponse(call: Call<PublishAd>, response: Response<PublishAd>) {
                        publishAd.value = response.body()
                    }
                    override fun onFailure(call: Call<PublishAd>, t: Throwable) {}
        ...
        call.enqueue(
                object : retrofit2.Callback<com.application.adverial.remote.model.Response> {
                    override fun onResponse(
                        ...
                        userUpdate.value = response.body()
                    }
                    override fun onFailure(
                            call: Call<com.application.adverial.remote.model.Response>,
                            t: Throwable
    ...
    fun currency() {
        ...
        call.enqueue(
                object : retrofit2.Callback<Currency> {
    ...
    fun filterCategory(category_id: String, json: String) {
        ...
        call.enqueue(
                object : retrofit2.Callback<Filter> {
        ...
        call.enqueue(
                object : retrofit2.Callback<com.application.adverial.remote.model.Response> {
                    override fun onResponse(
                        ...
                        adFeedback.value = response.body()
                    }
                    override fun onFailure(
                            call: Call<com.application.adverial.remote.model.Response>,
                            t: Throwable
        ...
        call.enqueue(
                object : retrofit2.Callback<com.application.adverial.remote.model.Response> {
                    override fun onResponse(
                        ...
                        deleteAccount.value = response.body()
                    }
                    override fun onFailure(
                            call: Call<com.application.adverial.remote.model.Response>,
                            t: Throwable
    ...
    fun getBackground() {
        ...
        call.enqueue(
                object : retrofit2.Callback<BackgroundResponseModel> {
                    override fun onResponse(
    ...
    fun adAutoComplete(keyword: String) {
        ...
        call.enqueue(
                object : retrofit2.Callback<AutoComplete> {
                    override fun onResponse(
    ...
    fun getCategoryAdsData(): MutableLiveData<CategoryAds> {
        return categoryAds
    }
    fun getSignupData(): MutableLiveData<Signup> {
        return signup
    }
    fun getLoginData(): MutableLiveData<Signup> {
        return login
    }
    fun getCategoryData(): MutableLiveData<Category> {
        return category
    }
    fun getAdDetailsData(): MutableLiveData<AdDetails> {
        return adDetails
    }
    fun getShowRoomData(): MutableLiveData<ShowRoom> {
        return showRoom
    }
    fun getSearchData(): MutableLiveData<Search> {
        return search
    }
    fun getClearSearchData(): MutableLiveData<com.application.adverial.remote.model.Response> {
        return clearSearch
    }
    fun getLatestSearchData(): MutableLiveData<LatestSearch> {
        return latestSearch
    }
    fun getFavoriteData(): MutableLiveData<Favorite> {
        return favorite
    }
    fun getRemoveFavoriteData(): MutableLiveData<com.application.adverial.remote.model.Response> {
        return removeFavorite
    }
    fun getAddFavoriteData(): MutableLiveData<com.application.adverial.remote.model.Response> {
        return addFavorite
    }
    fun getActiveAdsData(): MutableLiveData<Search> {
        return activeAds
    }
    fun getDeactiveAdsData(): MutableLiveData<Search> {
        return deactiveAds
    }
    fun getRemoveAdData(): MutableLiveData<com.application.adverial.remote.model.Response> {
        return removeAd
    }
    fun getCategoryOptionsData(): MutableLiveData<CategoryOptions> {
        return categoryOptions
    }
    fun getAddAdInfoData(): MutableLiveData<AddAdInfo> {
        return addAdInfo
    }
    fun getCountryData(): MutableLiveData<City> {
        return country
    }
    fun getCityData(): MutableLiveData<City> {
        return city
    }
    fun getDistrictData(): MutableLiveData<City> {
        return district
    }
    fun getAddAdLocationData(): MutableLiveData<com.application.adverial.remote.model.Response> {
        return addAdLocation
    }
    fun getImageData(): MutableLiveData<ImageUpload> {
        return image
    }
    fun getPublishAdData(): MutableLiveData<PublishAd> {
        return publishAd
    }
    fun getUserData(): MutableLiveData<User> {
        return user
    }
    fun getUserUpdateData(): MutableLiveData<com.application.adverial.remote.model.Response> {
        return userUpdate
    }
    fun getDeleteImageData(): MutableLiveData<com.application.adverial.remote.model.Response> {
        return deleteImage
    }
    fun getNotificationData(): MutableLiveData<Notification> {
        return notification
    }
    fun getContactUsData(): MutableLiveData<com.application.adverial.remote.model.Response> {
        return contactUs
    }
    fun getCurrencyData(): MutableLiveData<Currency> {
        return currency
    }
    fun getFilterCategoryData(): MutableLiveData<Filter> {
        return filter
    }
