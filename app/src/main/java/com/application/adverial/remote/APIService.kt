...
interface APIService {
        ...
        @GET
        fun categoryOptions(@Header("lang") lang: String, @Url url: String): Call<CategoryOptions>
        ...
        fun getAdReviews(
                ...
                @Header("content-type") contentType: String,
                @Header("lang") lang: String
        ): Call<com.application.adverial.remote.model.ReviewResponse>

        @FormUrlEncoded
        @POST("ads/{ad_id}/review")
        fun submitAdReview(
                @Path("ad_id") adId: String,
                ...
                @Header("lang") lang: String
        ): Call<com.application.adverial.remote.model.ReviewSubmitResponse>
}
