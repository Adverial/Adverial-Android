...
class SearchResult : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Tools().changeViewFromTheme(this,searchResultRoot)
    ...
    private fun pageInit(){
        ...
        result_name.text= keyword
        result_recyclerView.layoutManager= LinearLayoutManager(this)
        val repo= Repository(this)
        repo.search(keyword, "")
        repo.getSearchData().observe(this, {
            result_count.text= "${it.data!!.size} ${getString(R.string.result_count)}"
